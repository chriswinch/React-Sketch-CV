...
/* WEBPACK VAR INJECTION */(function(setTimeout) {// shim for using process in browser
...
var _expandStyle = __webpack_require__(89);
...
var _layerGroup = __webpack_require__(82);
...
var _Platform = __webpack_require__(76);
...
var _Artboard = __webpack_require__(78);

var _Artboard2 = _interopRequireDefault(_Artboard);

var _Image = __webpack_require__(79);
...
var _TextStylePropTypes = __webpack_require__(80);
...
var _shapeLayers = __webpack_require__(27);
...
var _hasAnyDefined = __webpack_require__(28);
...
var _sharedTextStyles = __webpack_require__(94);

var _sharedTextStyles2 = _interopRequireDefault(_sharedTextStyles);

var _hacksForJSONImpl = __webpack_require__(26);
...
var _murmur2js = __webpack_require__(71);

var _murmur2js2 = _interopRequireDefault(_murmur2js);

var _sortObjectKeys = __webpack_require__(93);
...
var _reactSketchapp = __webpack_require__(37);

var _design = __webpack_require__(64);
...
var Header = function Header() {
  return _react2['default'].createElement(
    ...
    { name: 'Header', style: styles.headerWrapper },
    _react2['default'].createElement(
      _reactSketchapp.View,
      { name: 'Name', style: styles.headerName },
      _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      _reactSketchapp.View,
      { name: 'Contact Details', style: styles.contact },
      _react2['default'].createElement(
        _reactSketchapp.Text,
        { name: 'Contact Heading', style: _design.fonts.subHeading2 },
        '/ Contact'
      ),
      _react2['default'].createElement(
        _reactSketchapp.Text,
        { name: 'Contact Info', style: [_design.fonts.body, styles.contactText] },
        '07446055398 hello@chriswinch.me'
      )
    ),
    _react2['default'].createElement(
      _reactSketchapp.View,
      { name: 'Contact Address', style: styles.contact },
      _react2['default'].createElement(
        _reactSketchapp.Text,
        { name: 'Contact Heading', style: _design.fonts.subHeading2 },
        '/ Address'
      ...
      _react2['default'].createElement(
        _reactSketchapp.Text,
        { name: 'Address', style: [_design.fonts.body, styles.contactText] },
        _react2['default'].createElement(
          _reactSketchapp.Text,
          { name: 'Street' },
          '31 Queen Square'
...
var styles = _reactSketchapp.StyleSheet.create({
  artboard: {
    height: _design.artboard.height,
    width: _design.artboard.width
  }
});
...
var Document = function Document() {
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      _react2['default'].createElement(_components.AboutMe, null)
    ),
    _react2['default'].createElement(
      _components.Section,
      { name: 'Experience', title: 'Experience' },
      _react2['default'].createElement(_components.Experience, null)
    ),
    _react2['default'].createElement(
      _components.Section,
      null,
      _react2['default'].createElement(_components.ContentRow, null)
    ),
...
var _reactTestRenderer = __webpack_require__(95);

var _reactTestRenderer2 = _interopRequireDefault(_reactTestRenderer);

var _cssLayout = __webpack_require__(66);

var _cssLayout2 = _interopRequireDefault(_cssLayout);

var _Context = __webpack_require__(90);

var _Context2 = _interopRequireDefault(_Context);

var _createStringMeasurer = __webpack_require__(92);
...
var _renderers = __webpack_require__(88);
...
var _buildTree = __webpack_require__(77);

var _buildTree2 = _interopRequireDefault(_buildTree);

var _flexToSketchJSON = __webpack_require__(81);
...
var _textLayers = __webpack_require__(83);
...
var renderers = {
  artboard: __webpack_require__(85),
...
var ReactTestEmptyComponent = __webpack_require__(110);
var invariant = __webpack_require__(1);
...
var AboutMe = function AboutMe() {
  return _react2['default'].createElement(
    _reactSketchapp.View,
    { name: 'About Me', style: styles.wrapper },
    _react2['default'].createElement(
      _reactSketchapp.Text,
      { style: _design.fonts.body },
      'Enthusiastic and self motivated Frontend Developer with over 10 years experience in building websites for a wide variety of clients. Freelancing has allowed me to work in multiple environments with different teams which has let me gain a flexible approach to development. I can easily be dropped into a team and hit the ground running. I enjoy solving problems and learning new technologies.'
    )
  );
};
...
var Section = function Section(_ref) {
  ...
  return _react2['default'].createElement(
    _reactSketchapp.View,
    { name: 'Section ' + String(title || ''), style: styles.wrapper },
    title && _react2['default'].createElement(
      _reactSketchapp.Text,
      { name: 'Section Heading', style: [_design.fonts.h4, styles.sectionHeading] },
      title
    ),
    _react2['default'].createElement(
      _reactSketchapp.View,
...
var _ExperienceItem = __webpack_require__(163);
...
var Experience = function Experience() {
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(_ExperienceItem.ExperienceItem, { data: data }),
    _react2['default'].createElement(_ExperienceItem.ExperienceItem, { data: data }),
    _react2['default'].createElement(_ExperienceItem.ExperienceItem, { data: data }),
    _react2['default'].createElement(_ExperienceItem.ExperienceItem, { data: data })
  );
...
exports.ExperienceItem = undefined;
...
var styles = _reactSketchapp.StyleSheet.create({
  wrapper: {
    marginBottom: 15,
    width: _design.artboard.width / 2 - 50
  },
  titleWrapper: {
    flexDirection: 'row',
    alignItems: 'flex-end',
...
var ExperienceItem = function ExperienceItem(_ref) {
  ...
  return _react2['default'].createElement(
    _reactSketchapp.View,
    { name: 'Experience ' + String(data.title), style: styles.wrapper },
    _react2['default'].createElement(
      _reactSketchapp.View,
      ...
      _react2['default'].createElement(
        _reactSketchapp.Text,
        { style: [_design.fonts.subHeading3, styles.titleItem, { paddingBottom: 1 }] },
...
var _AboutMe = __webpack_require__(135);

Object.keys(_AboutMe).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
...
var _Experience = __webpack_require__(162);
...
Object.keys(_ExperienceItem).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      function get() {
        return _ExperienceItem[key];
      }
...
var _ContentRow = __webpack_require__(167);

Object.keys(_ContentRow).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      function get() {
        return _ContentRow[key];
      }
...
var styles = _reactSketchapp.StyleSheet.create({
  ...
  contentItem: {
    width: _design.artboard.width / 3 - 40
  },
  contentItemTitle: {
    marginBottom: 5
  }
...
var ContentRow = function ContentRow() {
  return _react2['default'].createElement(
    _reactSketchapp.View,
    { style: styles.wrapper },
    _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          _reactSketchapp.Text,
          { style: _design.fonts.body },
          'HTML5 / CSS3 & SASS / JAVASCRIPT / ES6 / REACT / REACT NATIVE / WEBPACK & GULP / MOCHA / JEST / NODE / PHP / WORDPRESS / FOUNDATION & BOOTSTRAP / SHOPIFY / SKETCH / ADOBE CREATIVE SUITE'
        )
      )
    ),
    _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          _reactSketchapp.Text,
          { style: _design.fonts.body },
          'I am proudly self taught and have felt that due to the fast paced nature of our industry that this has let me learn and adapt quickly. I am constantly learning and try to pick up new technologies / tools as they are needed.'
        ),
        _react2['default'].createElement(
          _reactSketchapp.Text,
          { style: _design.fonts.body },
